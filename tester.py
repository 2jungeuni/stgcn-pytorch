...
if __name__ == "__main__":
    ...
    checkpoint = torch.load("../stgcn/output/pemsd7-m/pred_30mins/pemsd7-m_best.pth",
                            map_location=device,
                            weights_only=False)
    model.load_state_dict(checkpoint['model_state_dict'])
    model.to(device)
    ...
    plt.title("Velocity Prediction (30 mins)", fontsize=16, fontweight='bold')
